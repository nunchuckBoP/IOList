    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description_1', models.CharField(max_length=26, verbose_name='Desc 1')),
                ('description_2', models.CharField(max_length=26, verbose_name='Desc 2')),
                ('description_3', models.CharField(max_length=26, verbose_name='Desc 3')),
                ('description_4', models.CharField(max_length=26, verbose_name='Desc 4')),
